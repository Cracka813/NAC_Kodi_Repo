...
ADDON=xbmcaddon.Addon(id='plugin.video.NACTVBox.com Wizard')
dialog = xbmcgui.Dialog()    
VERSION = "1.1"
PATH = "NACTVBox.com Wizard"            

    
def CATEGORIES():
    link = OPEN_URL('https://www.dropbox.com/s/wyqf3fkx6mw88ay/wizard.txt?dl=1').replace('\n','').replace('\r','')
