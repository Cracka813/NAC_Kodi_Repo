...
base='http://www.nactvbox.com'
ADDON=xbmcaddon.Addon(id='NACTVBox.com Confluence Build Wizard v1.2')
dialog = xbmcgui.Dialog()    
VERSION = "1.1"
PATH = "NACTVBox.com_Wizard_v1.2"            

    
def CATEGORIES():
    link = OPEN_URL('https://www.dropbox.com/s/gzubqqoqmbou8ls/wizard.txt?dl=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("NACTVBox.com Wizard","Downloading ",'', 'Please Wait')
